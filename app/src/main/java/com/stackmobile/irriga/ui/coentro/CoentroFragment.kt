package com.stackmobile.irriga.ui.coentro
...
import com.stackmobile.irriga.databinding.FragmentCoentroBinding
//import kotlinx.android.synthetic.main.fragment_coentro.*


class CoentroFragment : Fragment() {

    val database = FirebaseDatabase.getInstance()
    var pieChart : PieChart? = null

    private lateinit var binding: FragmentCoentroBinding

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View {
        binding = FragmentCoentroBinding.inflate(inflater, container, false)
    ...
    private fun getStats() {
        ...
        val myRef3 = database.getReference("IrrigadorAuto/mediacoentro")
