package com.stackmobile.irriga.ui.couve
...
import com.stackmobile.irriga.databinding.FragmentCouveBinding


@Suppress("UNREACHABLE_CODE")
class CouveFragment : Fragment() {

    private lateinit var binding: FragmentCouveBinding
    ...
    private fun getStats() {
        ...
        val myRef3 = database.getReference("IrrigadorAuto/mediacouve")
