package com.stackmobile.irriga.ui.cebolinha
...
import com.stackmobile.irriga.databinding.FragmentCebolinhaBinding


class CebolinhaFragment : Fragment() {

    val database = FirebaseDatabase.getInstance()
    var pieChart : PieChart? = null

private lateinit var binding: FragmentCebolinhaBinding

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View {
        binding = FragmentCebolinhaBinding.inflate(inflater, container, false)

        //Aqui pegamos o que está sendo inflado no
        // localizamos no layout o Pie que vai ser modificado
        pieChart = binding.piechart4
    ...
    private fun getStats() {
        ...
        val myRef3 = database.getReference("IrrigadorAuto/mediacebolinha")
